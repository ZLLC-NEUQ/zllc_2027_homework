...
inline float Class_Gimbal_Pitch_Motor_DM4310::Get_True_Rad_Pitch()
{
    return True_Rad_Pitch;
}

inline float Class_Gimbal_Pitch_Motor_DM4310::Get_True_Angle_Pitch()
{
    return True_Angle_Pitch;
}

inline float Class_Gimbal_Pitch_Motor_DM4310::Get_True_Gyro_Pitch()
{
...
inline float Class_Gimbal_Yaw_Motor_LK7025::Get_True_Rad_Yaw()
{
    return True_Rad_Yaw;
}

inline float Class_Gimbal_Yaw_Motor_LK7025::Get_True_Angle_Yaw()
{
    return True_Angle_Yaw;
}

inline float Class_Gimbal_Yaw_Motor_LK7025::Get_True_Gyro_Yaw()
{
    return True_Gyro_Yaw;
}
